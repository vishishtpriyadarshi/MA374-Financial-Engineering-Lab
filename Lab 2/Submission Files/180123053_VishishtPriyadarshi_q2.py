...
def binomial_model(S0, K, T, M, r, sigma, set, display):
  ...
  for i in range(int(pow(2, M))):
    avg_price = compute_option_price(i, S0, K, u, d, M)
...
def plot_S0():
  ...
  for set_num in range(1, 3):
    ...
    put_option_prices = []
    for s in S:
      c, p = binomial_model(S0 = s, K = 100, T = 1, M = 10, r = 0.08, sigma = 0.20, set = set_num, display = 0)
...
def plot_K():
  ...
  for set_num in range(1, 3):
    ...
    put_option_prices = []
    for k in K:
      c, p = binomial_model(S0 = 100, K = k, T = 1, M = 10, r = 0.08, sigma = 0.20, set = set_num, display = 0)
      call_option_prices.append(c)
      put_option_prices.append(p)
...
def plot_r():
  r_list =  np.linspace(0, 0.6, 100)

  for set_num in range(1, 3):
    call_option_prices = []
    put_option_prices = []
    for rate in r_list:
      c, p = binomial_model(S0 = 100, K = 100, T = 1, M = 10, r = rate, sigma = 0.20, set = set_num, display = 0)
      call_option_prices.append(c)
      put_option_prices.append(p)
...
def plot_sigma():
  sigma_list =  np.linspace(0.1, 1, 100)

  for set_num in range(1, 3):
    call_option_prices = []
    put_option_prices = []
    for sg in sigma_list:
      c, p = binomial_model(S0 = 100, K = 100, T = 1, M = 10, r = 0.08, sigma = sg, set = set_num, display = 0)
      call_option_prices.append(c)
      put_option_prices.append(p)
...
def plot_S0_K():
  ...
  for set_num in range(1, 3):
    ...
    for s in S:
      for k in K:
        c, p = binomial_model(S0 = s, K = k, T = 1, M = 10, r = 0.08, sigma = 0.20, set = set_num, display = 0)
        x_axis.append(s)
        y_axis.append(k)
        call_option_prices.append(c)
        put_option_prices.append(p)

    plot_fixed_3d(x_axis, y_axis, call_option_prices, "S0", "K", "Prices of Call option at t = 0", "Initial Call Option Price vs S0 for the set = " + str(set_num))
    plot_fixed_3d(x_axis, y_axis, put_option_prices, "S0", "K", "Prices of Put option at t = 0", "Initial Put Option Price vs S0 for the set = " + str(set_num))


def plot_S0_r():
  S =  np.linspace(20, 200, 50)
  r_list =  np.linspace(0, 0.6, 50)
  ...
  for set_num in range(1, 3):
    ...
    for s in S:
      for rate in r_list:
        c, p = binomial_model(S0 = s, K = 100, T = 1, M = 10, r = rate, sigma = 0.20, set = set_num, display = 0)
        x_axis.append(s)
        y_axis.append(rate)
        call_option_prices.append(c)
        put_option_prices.append(p)
...
def plot_S0_sigma():
  ...
  for set_num in range(1, 3):
    ...
    for s in S:
      for sg in sigma_list:
        c, p = binomial_model(S0 = s, K = 100, T = 1, M = 10, r = 0.08, sigma = sg, set = set_num, display = 0)
        x_axis.append(s)
        y_axis.append(sg)
        call_option_prices.append(c)
        put_option_prices.append(p)
...
def plot_K_r():
  ...
  for set_num in range(1, 3):
    ...
    for k in K:
      for rate in r_list:
        c, p = binomial_model(S0 = 100, K = k, T = 1, M = 10, r = rate, sigma = 0.20, set = set_num, display = 0)
        x_axis.append(k)
        y_axis.append(rate)
        call_option_prices.append(c)
        put_option_prices.append(p)
...
def plot_K_sigma():
  ...
  for set_num in range(1, 3):
    ...
    for k in K:
      for sg in sigma_list:
        c, p = binomial_model(S0 = 100, K = k, T = 1, M = 10, r = 0.08, sigma = sg, set = set_num, display = 0)
        x_axis.append(k)
        y_axis.append(sg)
        call_option_prices.append(c)
        put_option_prices.append(p)
...
def plot_r_sigma():
  r_list =  np.linspace(0, 0.6, 50)
  sigma_list =  np.linspace(0.3, 1, 50)
  ...
  for set_num in range(1, 3):
    ...
    for rate in r_list:
      for sg in sigma_list:
        c, p = binomial_model(S0 = 100, K = 100, T = 1, M = 10, r = rate, sigma = sg, set = set_num, display = 0)
        x_axis.append(rate)
        y_axis.append(sg)
        call_option_prices.append(c)
        put_option_prices.append(p)
...
def main():
  binomial_model(S0 = 100, K = 100, T = 1, M = 10, r = 0.08, sigma = 0.20, set = 1, display = 1)
  binomial_model(S0 = 100, K = 100, T = 1, M = 10, r = 0.08, sigma = 0.20, set = 2, display = 1)
  plot_S0()
  plot_K()
  plot_r()
  plot_sigma()
